...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // 0-9 全てのパスデータ定義 (日本の小学校での書き順・標準字体に準拠)
    const NUMBER_DATA = {
        '0': { paths: ['M 50 15 C 25 15, 20 40, 20 50 C 20 60, 25 85, 50 85 C 75 85, 80 60, 80 50 C 80 40, 75 15, 50 15'] },
        ...
        '9': { paths: ['M 75 35 C 75 15, 25 15, 25 35 C 25 55, 75 55, 75 35 L 75 85'] }
    };
